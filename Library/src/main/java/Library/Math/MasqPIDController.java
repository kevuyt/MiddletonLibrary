...
public class MasqPIDController {
    private final MasqIntegrator integrator = new MasqIntegrator();
    private double kp = 0;
    private double ki = 0;
    private double kd = 0;
    ...
    public double getOutput (double error) {
        ...
        return clip((error * kp) + (ki * integral) + (kd * derivative),-1,1);
    }

    public double[] getConstants() {return new double[] {kp, ki, kd};}
