...
import Library.Math.MasqPIDController;
import Library.Math.MasqVector;
import Library.Odometry.Tracker;
...
public class Utils {
    ...
    public static void setLinearOpMode(OpMode opMode) {
        Utils.opMode = opMode;}
    public static OpMode getLinearOpMode() {return opMode;}
    public static boolean opModeIsActive() {return opMode.opModeIsActive();}
    public static HardwareMap getHardwareMap() {return opMode.hardwareMap;}
    public static void setTracker(Tracker positionTracker) {tracker = positionTracker;}
