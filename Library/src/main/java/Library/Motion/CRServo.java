...
public class CRServo {
    ...
    public CRServo(String name){
        ...
        this.servo = new CRServoImplEx((ServoControllerEx) servo.getController(),
                servo.getPortNumber(), ServoConfigurationType.getStandardServoType());
    ...
    public void setPower (double power) {
        ...
        if (limitDetection) if (min != null && min.isPressed() && power < 0 || max != null &&
                max.isPressed() && power > 0) motorPower = 0;
