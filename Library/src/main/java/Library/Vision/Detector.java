...
import static Library.Resources.Utils.getDash;
...
public abstract class Detector extends OpenCvPipeline {
    ...
    protected List<MatOfPoint> findContours(ColorFilter filter, Mat mask) {
    ...
    protected List<Rect> contoursToRects(List<MatOfPoint> contours) {
        ...
        for (MatOfPoint contour : contours) rects.add(Imgproc.boundingRect(contour));
        return rects;
    }
